...
<head>
    ...
    <body>
		...
		<section id="education" class="mt-4">
			<div class="row">
				<div class="col-md-8">
					<h2 class="text-warning">My Education</h2>
			...
			<section id="skills" class="mt-4">
				<div class="row">
					<div class="col-md-12">
						<h2 class="text-warning">My Skills</h2>
			...
			<section id="expirience" class="mt-4">
				<h2 class="text-warning">My expirience</h2>
				<p>10/2019 - now, QA Engineer at Picanova Group</p>
				<p>02/2016 - 07/2016, Internship at Optimum Web</p>
			</section>		

           
			<section id="my_work" class="mt-4">
				<div class="row">
					<div class="col-md-12">
						<h2 class="text-warning">My work examples:</h2>
						<ul>
